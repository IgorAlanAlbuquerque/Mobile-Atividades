package com.igor.postapp.ui.screens
...
import com.igor.postapp.viewmodel.PostViewModel
import com.igor.postapp.data.models.Post
        ...
        Column(
            ...
            Button(
                onClick = {
                    ...
                    viewModel.createPost(title, content, onSuccess = {
                        Toast.makeText(context, "Post criado com sucesso",
                            Toast.LENGTH_SHORT).show()
                        isLoading = false
                    }, onError = {
                        Toast.makeText(context, "Erro ao criar Post!",
                            Toast.LENGTH_SHORT).show()
                        isLoading = false
                    })
                    title = ""
            ...
            if (editingPost != null) {
                AlertDialog(
                    ...
                    title = { Text(text = "Editar Post", color =
                        MaterialTheme.colorScheme.primary) },
                    text = {
                        Column {
                            TextField(
                                value = editingPost!!.title,
                                onValueChange = { editingPost = editingPost!!.copy(title
                                = it) },
                                label = { Text("Título") },
                                colors = TextFieldDefaults.colors(
