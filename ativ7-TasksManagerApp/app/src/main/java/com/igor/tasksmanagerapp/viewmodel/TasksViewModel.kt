package com.igor.tasksmanagerapp.viewmodel

import android.content.Context
import androidx.lifecycle.ViewModel
import androidx.lifecycle.viewModelScope
import com.igor.tasksmanagerapp.model.Task
import com.igor.tasksmanagerapp.model.TaskCategory
import com.igor.tasksmanagerapp.model.TaskPriority
import com.igor.tasksmanagerapp.utils.DataStoreUtils
...
class TasksViewModel(context: Context) : ViewModel() {
    ...
    private fun updateProgress(){
        ...
        _progress.value = if (_tasks.value.isNotEmpty()){
            completed.toFloat() / _tasks.value.size
        } else 0f
    }
